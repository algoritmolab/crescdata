    ...
    <li className="border-b border-rule">
      ...
      >
        ...
        <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_180px_112px_96px_104px] lg:items-center lg:gap-7">
          <h3 className="font-display text-xl font-semibold tracking-[-0.025em] text-navy transition-colors group-hover:text-brand-600 lg:text-2xl">
            {role.title}
          </h3>

          <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-2 font-mono text-[11px] uppercase tracking-[0.16em] text-muted lg:contents">
