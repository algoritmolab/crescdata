    ...
    <article className="border border-rule bg-surface">
      ...
      <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_270px]">
        <div className="px-5 py-8 sm:px-8 sm:py-12">
          ...
          <Link
            href={`/whitepapers/${paper.slug}`}
            className="group mt-8 inline-flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.2em] text-brand-600 transition-colors hover:text-brand-700"
          >
            Open document
            <span
              aria-hidden="true"
